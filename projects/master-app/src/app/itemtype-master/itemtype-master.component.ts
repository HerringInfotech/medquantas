...
@Component({
  selector: 'app-itemtype-master',
  templateUrl: './itemtype-master.component.html',
  styleUrls: ['./itemtype-master.component.scss']
})
export class ItemtypeMasterComponent implements OnInit {
  ...
  get_itemtype(page) {
    ...
    this.api.post('get_itemtype', params).subscribe((response) => {
      ...
      this.spinner.hide();
      this.catagory = response.data.itemtype.docs
