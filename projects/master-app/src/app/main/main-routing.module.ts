...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'group', canActivate: [AuthGuard], data: { permission: 'Groupmaster.List' }, loadChildren: () => import('../item-group-master/group-master.module').then(m => m.GroupMasterModule) },
      ...
      { path: 'fg_master', canActivate: [AuthGuard], data: { permission: 'FGmaster.List' }, loadChildren: () => import('../fg-master/fg-master.module').then(m => m.FgMasterModule) },
